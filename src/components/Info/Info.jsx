...
const Info = () => {
  ...
  return (
    <div>
      ...
      <div className="bg-black rounded-[57px] pl-[127px] pr-[161px] max-md:px-[40px] text-white mx-[50px] max-md:mx-[11px] py-[90px] pb-[50px]">
        <div>
            ...
            <p
              ...
              className={`sofia-extralight text-2xl ${
                i === 0
                  ...
                  : "md:px-[38px] py-5 sofia-extralight"
              }`}
            >
              <Trans
        ...
        <div className="flex max-md:justify-center mt-[80px]">
          <Button
            className="bg-white rounded-full text-black py-[15px] px-[50px] max-md:w-full"
